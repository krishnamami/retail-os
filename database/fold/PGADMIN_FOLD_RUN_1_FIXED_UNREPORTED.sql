-- =====================================================================
-- STEP 4I: FOLD FUNCTION FIX — Preserve UNREPORTED Properties (Empty Basis Arrays)
-- =====================================================================
-- CRITICAL FIX: Changed CROSS JOIN UNNEST to LEFT JOIN LATERAL UNNEST
-- This preserves properties with empty basis_ids (UNREPORTED state)
-- =====================================================================
...
-- =====================================================================
-- STEP 1: CLEANUP — DELETE EXISTING SNAPSHOTS
-- =====================================================================
...
-- =====================================================================
-- STEP 2: RE-EXECUTE FOLD RUN #1 (With Fixed UNREPORTED Handling)
-- =====================================================================

SELECT * FROM runtime.fold_snapshot_at_horizon('2026-06-20 10:45:00+00'::timestamptz);

-- =====================================================================
-- STEP 3: 12 VALIDATION QUERIES
-- =====================================================================
