-- =====================================================================
-- STEP 5B.1 SECTIONS 2, 9, 12 CORRECTED
-- Proper aggregation: each section returns ONE row with all data concatenated
-- =====================================================================
...
BEGIN
  BEGIN
    ...
    SELECT COUNT(*) INTO v_count FROM matrix_data WHERE concept IS NOT NULL;
...
BEGIN
  BEGIN
    ...
    SELECT COUNT(*) INTO v_count FROM rules_data;
...
BEGIN
  BEGIN
    ...
    SELECT COUNT(*) INTO v_count FROM requirements_data;
...
SELECT '=== SECTIONS 2, 9, 12 RESULTS ===' AS title;
