-- =====================================================================
-- Raw → Evidence Transformation Procedure
-- =====================================================================
-- Purpose: Transform raw.raw_event (169 rows) into runtime.evidence using
--          38 approved deterministic mappings
...
BEGIN
  ...
  -- =====================================================================
  -- TRANSFORMATION: Apply all 38 approved mappings deterministically
  -- =====================================================================
  ...
  -- 2. HIERARCHY_APPROVAL → 4-6 Evidence rows (CON code, CON auth, PRD code, PRD auth)
  -- Handle CON hierarchy
  INSERT INTO runtime.evidence (
    raw_event_id, mapping_id, evidence_type, subject_type, subject_id,
    property_name, asserted_value, value_type, source_system, source_actor_id,
    source_actor_role, occurred_at, recorded_at, arrival_at, evidence_lineage, created_at
  ...
  SELECT
    ...
    'launch',
    r.launch_id,
    'hierarchy_approval_authority_con',
    con_approval->'approval_authority'->>'value',
    'string',
    'approval_workflow',
    con_approval->'approval_authority'->>'value',
  ...
  SELECT
    ...
    'launch',
    r.launch_id,
    'hierarchy_approval_authority_prd',
    prd_approval->'approval_authority'->>'value',
    'string',
    'approval_workflow',
    prd_approval->'approval_authority'->>'value',
  ...
  -- 3. SAP_CON_LOADED → 3 Evidence rows
  INSERT INTO runtime.evidence (
    raw_event_id, mapping_id, evidence_type, subject_type, subject_id,
    property_name, asserted_value, value_type, source_system, source_actor_id,
    source_actor_role, occurred_at, recorded_at, arrival_at, evidence_lineage, created_at
  ...
  -- 4. SAP_PRD_LOADED → 3 Evidence rows (similar to SAP_CON)
  INSERT INTO runtime.evidence (
    raw_event_id, mapping_id, evidence_type, subject_type, subject_id,
    property_name, asserted_value, value_type, source_system, source_actor_id,
    source_actor_role, occurred_at, recorded_at, arrival_at, evidence_lineage, created_at
  ...
  -- 11. TECHNICAL_REVIEW → 1-2 Evidence rows (VALID ZERO for missing review)
  INSERT INTO runtime.evidence (
    raw_event_id, mapping_id, evidence_type, subject_type, subject_id,
    property_name, asserted_value, value_type, source_system, source_actor_id,
    source_actor_role, occurred_at, recorded_at, arrival_at, evidence_lineage, created_at
  ...
  -- 13. PRICING_UPLOADED → 1 Evidence row
  INSERT INTO runtime.evidence (
    raw_event_id, mapping_id, evidence_type, subject_type, subject_id,
    property_name, asserted_value, value_type, source_system, source_actor_id,
    source_actor_role, occurred_at, recorded_at, arrival_at, evidence_lineage, created_at
  ...
  -- 15. PRICING_PUBLISHED → 1 Evidence row
  INSERT INTO runtime.evidence (
    raw_event_id, mapping_id, evidence_type, subject_type, subject_id,
    property_name, asserted_value, value_type, source_system, source_actor_id,
    source_actor_role, occurred_at, recorded_at, arrival_at, evidence_lineage, created_at
  ...
  -- 17. ZUPDM_APPROVED → 1 Evidence row
  INSERT INTO runtime.evidence (
    raw_event_id, mapping_id, evidence_type, subject_type, subject_id,
    property_name, asserted_value, value_type, source_system, source_actor_id,
    source_actor_role, occurred_at, recorded_at, arrival_at, evidence_lineage, created_at
  ...
  -- 20. GO_LIVE_APPROVED → 2 Evidence rows
  INSERT INTO runtime.evidence (
    raw_event_id, mapping_id, evidence_type, subject_type, subject_id,
    property_name, asserted_value, value_type, source_system, source_actor_id,
    source_actor_role, occurred_at, recorded_at, arrival_at, evidence_lineage, created_at
  ...
  -- 21. SUPPLY_CHAIN_NOTIFIED → 1 Evidence row
  INSERT INTO runtime.evidence (
    raw_event_id, mapping_id, evidence_type, subject_type, subject_id,
    property_name, asserted_value, value_type, source_system, source_actor_id,
    source_actor_role, occurred_at, recorded_at, arrival_at, evidence_lineage, created_at
  ...
  -- 22. OVERNIGHT_PUSH → 2 Evidence rows
  INSERT INTO runtime.evidence (
    raw_event_id, mapping_id, evidence_type, subject_type, subject_id,
    property_name, asserted_value, value_type, source_system, source_actor_id,
    source_actor_role, occurred_at, recorded_at, arrival_at, evidence_lineage, created_at
  ...
  -- 38. CHANGE_TYPE → Part 1 of 4 CHANGE_REQUESTED mappings (1 record only)
  INSERT INTO runtime.evidence (
    raw_event_id, mapping_id, evidence_type, subject_type, subject_id,
    property_name, asserted_value, value_type, source_system, source_actor_id,
    source_actor_role, occurred_at, recorded_at, arrival_at, evidence_lineage, created_at
  ...
  SELECT
    ...
    jsonb_build_object(
      ...
      'note', 'Only 1 CHANGE_REQUESTED record in corpus - preserve lineage only'
    ),
    CURRENT_TIMESTAMP
  FROM raw.raw_event r
  ...
  -- 39. CHANGE_REASON → Part 2 of 4 CHANGE_REQUESTED mappings
  INSERT INTO runtime.evidence (
    raw_event_id, mapping_id, evidence_type, subject_type, subject_id,
    property_name, asserted_value, value_type, source_system, source_actor_id,
    source_actor_role, occurred_at, recorded_at, arrival_at, evidence_lineage, created_at
  ...
  -- 40. CHANGE_REQUESTED_BY → Part 3 of 4 CHANGE_REQUESTED mappings
  INSERT INTO runtime.evidence (
    raw_event_id, mapping_id, evidence_type, subject_type, subject_id,
    property_name, asserted_value, value_type, source_system, source_actor_id,
    source_actor_role, occurred_at, recorded_at, arrival_at, evidence_lineage, created_at
  ...
  -- 41. CHANGE_REQUESTER_ROLE → Part 4 of 4 CHANGE_REQUESTED mappings
  INSERT INTO runtime.evidence (
    raw_event_id, mapping_id, evidence_type, subject_type, subject_id,
    property_name, asserted_value, value_type, source_system, source_actor_id,
    source_actor_role, occurred_at, recorded_at, arrival_at, evidence_lineage, created_at
