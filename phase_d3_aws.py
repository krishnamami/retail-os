...
async def phase_d3_execute():
    ...
    try:
        ...
        print(f'✓ Connected to accord at {credentials["host"]}')
    except Exception as e:
    ...
    try:
        async with pool.acquire() as conn:
            ...
            print(f'Baseline: config={canonical_count}, decision={decision_count}')
            ...
            print(f'✓ NOT RUNTIME-ACTIVE (status={use_status})')
