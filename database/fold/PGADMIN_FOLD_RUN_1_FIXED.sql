-- =====================================================================
-- STEP 4I: CORRECTED FOLD RUN #1 — DEPLOYMENT & EXECUTION (FIXED)
-- =====================================================================
-- CRITICAL: This version has the JSONB reference fix at line ~335-346
-- =====================================================================
...
FROM state.fold_state_snapshot fss, LATERAL UNNEST(fss.basis_assertion_ids) AS assertion_id
