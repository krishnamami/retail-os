-- =====================================================================
-- STEP 4H DEPLOYMENT — Execute in pgAdmin
-- =====================================================================
-- 1. Execute fold_state_logic_CORRECTED.sql FIRST (dependency)
-- 2. Execute fold_snapshot.sql SECOND
-- 3. Run verification queries after deployment
-- =====================================================================

-- =====================================================================
-- PART 1: DEPLOY fold_state_logic function
-- =====================================================================
-- Corrections:
-- - Line 80: property_value_type (schema fix)
-- - Line 162: v_id TEXT; (loop variable)
-- - Line 166: jsonb_array_elements_text() (scalar fix)
